...
let conditionInvite = isGuest && cartValue > 100;
let conditionIdentification = hasAccount || conditionInvite;
let commandeValidee = !isBanned && conditionIdentification;


if (commandeValidee) {
    console.log("Commande validée avec succès !");
} else {
    console.log("Impossible de valider la commande.");
}
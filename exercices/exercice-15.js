...
let prixPropre = prixExtrait.trim().replace(" MAD", "");

let prixNumerique = Number(prixPropre); 

let quantite = 2;
let prixTotal = prixNumerique * quantite;


console.log("Prix nettoyé (texte) :", `"${prixPropre}"`);
console.log("Prix converti (nombre) :", prixNumerique);
console.log("Type de la variable :", typeof prixNumerique);
